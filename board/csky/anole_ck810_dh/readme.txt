...
===============
	...
	$ make csky_anole_ck810_dh_gerrit_defconfig
	$ make
...
Check the 'board/csky/anole_ck810_dh/gdbinit', the IP and Port must be the same as DebugServer.
...
Run gdb and load vmlinux.
	...
	$ cd output/images
	$ ../host/usr/bin/csky-linux-gdb -x ../../board/csky/anole_ck810_dh/gdbinit ../build/<linux-kernel-dir>/vmlinux
