...
ifeq ($(BR2_csky),y)
CKUPS_BINUTILS_VERSION = 9c3adfb9a409a240bb4cf087f0adeb8b1472f67a
CKTST_BINUTILS_VERSION = c66d8bbcebfddf713b2b436e1b135e6b125a55a5
ifeq ($(BR2_CSKY_UPSTREAM),y)
BINUTILS_VERSION = $(CKUPS_BINUTILS_VERSION)
else
BINUTILS_VERSION = $(CKTST_BINUTILS_VERSION)
endif
