...
CKTST_UCLIBC_NG_TEST_VERSION = c6d62cbc60504c7f6867b486248b0ef7cc2da554
CKUPS_UCLIBC_NG_TEST_VERSION = c6d62cbc60504c7f6867b486248b0ef7cc2da554
ifeq ($(BR2_CSKY_UPSTREAM),y)
UCLIBC_NG_TEST_VERSION = $(CKUPS_UCLIBC_NG_TEST_VERSION)
else
UCLIBC_NG_TEST_VERSION = $(CKTST_UCLIBC_NG_TEST_VERSION)
endif
